...
<body class="font-[Poppins]">
  ...
  <!-- Background layer -->
  <div
    class="fixed inset-0 -z-10 bg-[url(assets/bg-theme.png)] bg-bottom bg-cover"></div>
  <!-- Scrollable content -->
              ...
              <div class="w-full mt-8">
                ...
                <div class="w-full mt-4">
                  <label
                    for="phone"
                    name="phone"
                    class="block text-sm font-semibold text-gray-700">Nomor Handphone</label>
  ...
  <section id="benefit" class="container mx-auto pt-8 pb-16">
    <div
      ...
      <div
        ...
        <div
          id="benefitList"
          class="bg-white rounded-xl shadow-[0px_0px_8px_0px_rgba(60,60,60,0.25)] divide-y divide-gray-200"></div>
      </div>
    </div>
  </section>
  <!-- KUOTA -->
